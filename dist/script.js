...
function redirecttoShare(platform, personalitytype){
  if(platform == 'facebook'){
    ...
    stringType = personalitytype;
    window.open("http://twitter.com/share?text= I found out my personality type " + stringType + ". Find out your type at personalityhero.com @Mastered_IE" + "&url=https://personalityhero.com&hashtags=personalityhero,whatsyourpersonality,quiz, Mastered_IE", "_blank");
  }
